...
| Benchmark                               | ScalaZ 7.2.16 | Cats 1.0.0-RC1 | Vanilla Scala | Haskell 8.0.2 |
|-----------------------------------------+---------------+----------------+---------------+---------------|
| ~Eq~ - same ~[Int]~                     | 78,653        | 2.5            | 2.4           | 3,974         |
| ~Eq~ - different ~[Int]~                | 80,508        | 3,983          | 5,180         |               |
| ~Eq~ - ~while~ w/ ~Int~                 | 3,226         | 199            | 198           |               |
| ~Eq~ (derived) - same ~[Foo]~           | 79,150        | 2.8            | 2.5           |               |
| ~Eq~ (derived) - different ~[Foo]~      | 80,737        | 38,630         | 2,071         |               |
| ~Eq~ (derived) - ~while~ w/ ~Foo~       | 470,323       | 40,113         | 5,335         |               |
| ~Eq~ (hand-written) - same ~[Foo]~      | 26,673        | 2.8            | 2.5           |               |
| ~Eq~ (hand-written) - different ~[Foo]~ | 26,638        | 7,835          | 2,071         |               |
| ~Eq~ (hand-written) - ~while~ w/ ~Foo~  | 10,771        | 5,341          | 5,335         |               |
