...
to either one. It seeks to answer the following question:
...
- [[https://www.manning.com/books/functional-programming-in-scala][Functional Programming in Scala]] by the ScalaZ authors
- [[https://leanpub.com/fpmortals][Functional Programming for Mortals]] by Sam Halliday (for beginners - assumes a Java background)
- Training by the [[http://fantasyland.institute/][Fantasyland Institute]]

Cats:

- [[https://underscore.io/books/advanced-scala/][Advanced Scala with Cats]] by Noel Welsh and Dave Gurnell (assumes 1+ years of Scala experience)
